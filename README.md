...
![A view of the index page with the password generator](./Assets/03-javascript-homework-demo.png)

### Url

```
The URL of the deployed application: https://newmanuel.github.io/3-Private.Access/

The URL of the GitHub repository: https://github.com/NewManuel/3-Private.Access
